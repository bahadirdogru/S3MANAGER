...
[Özellikler](#özellikler) · [Kurulum](#kurulum) · [Web sitesi](https://s3manager.bahadirdogru.com/) · [Roadmap](#roadmap) · [Kullanım](#kullanım) · [Dağıtım](#dağıtım-yerel-derleme) · [Dökümantasyon](#dökümantasyon)
...
> |-------|----------------|
> | [README.md](README.md) | Kurulum, kullanım, proje tanıtımı (İngilizce — GitHub/GitLab anasayfa) |
